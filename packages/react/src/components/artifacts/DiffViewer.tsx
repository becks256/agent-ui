    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-neutral-900 border-b border-neutral-800 text-[11px] select-none">
        <div className="flex items-center gap-2 text-neutral-300">
          ...
          <span className="font-sans font-medium">{filename || 'File Diff'}</span>
        </div>
      </div>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isHunk && 'bg-neutral-900 text-neutral-400 italic my-1 font-sans text-[10px]',
            ...
            >
              ...
              <span className="whitespace-pre flex-1">{line.replace(/^[+-]/, '')}</span>
            </div>
          );
        })}
      </div>
